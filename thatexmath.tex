...
\def\labelrel#1#2{\mathrel{{\buildrel{\text{\explanationstyle{(#2)}}} \over {#1}}}}
% handy uses:
\def\spaceq{\spacerel=}
...
\def\triplehearteq{{\buildrel{\heart} \over {\tripleeq}}}
\def\tripleheartiff{{\buildrel{\heart} \over {\tripleiff}}}
...
\def\hearteq{\mathrel{\triplehearteq}}
\def\heartiff{\;\mathrel{\tripleheartiff}\;}
