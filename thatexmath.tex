...
\def\cmod#1{&&\pmod{#1}}% use inside \modcompute
\def\noby{&\qquad&}
...
\def\fcase#1#2{\mathord{\bracket{#1,#2}}}
\def\fplus#1#2{\mathord{#1+#2}}% function-like (prefix) +
...
\def\chole{{\ensuremath{\colorbox{holecolor}{$\phantom{x}$}}}}
