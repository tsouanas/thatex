...
\def\syndefeq{\mathrel{{\buildrel{\text{\sixss def}} \over {\syneq}}}}
\def\syndefiff{\;\mathrel{{\buildrel{\text{\sixss def}} \over {\tripleiff}}\;}}
\def\sugardefeq{\mathrel{{\buildrel{\text{\sixss sug}} \over {\sugareq}}}}
\def\sugardefiff{\;\mathrel{{\buildrel{\text{\sixss sug}} \over {\tripleiff}}\;}}
\def\abusedefeq{\mathrel{{\buildrel{\text{\sixss abu}} \over {\inteq}}}}
\def\abusedefiff{\;\mathrel{{\buildrel{\text{\sixss abu}} \over {\intiff}}\;}}
\let\means=\intiff
\def\sugariff{\intiff}
\let\sugiff=\sugariff
...
\def\quantifierabbrt#1#2#3{\left(\/#1 #2\right)\!\quantified{\text{#3}}}
...
\def\projapp#1#2{\proj {#1} \app {#2}}% proj applied to arg
\def\projfrom#1#2{\pi^{#1}_{#2}}% projections of denoted arity (pi-notation)
\def\projfromapp#1#2#3{\projfrom {#1} {#2} \app {#3}}% projfrom applied to arg
