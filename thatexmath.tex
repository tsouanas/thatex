...
\def\poemcompute#1\endpoemcompute{$$\spreadmatrixlines{3pt}\poemcomputePRIME #1\endpoemcomputePRIME$$}
...
\def\data#1\enddata{$$\dataPRIME#1\enddataPRIME$$}
\def\dataed#1{\dataPRIME #1\enddataPRIME}
\def\datased#1{&\dataPRIME #1\enddataPRIME}
\def\datas#1 #2\enddatas{$$\let\dataed=\datased\xalignat#1\relax\fixmcount #2\endxalignat\saveeqnumber$$}
...
\def\fundef#1\endfundef{$$\spreadmatrixlines{3pt}\fundefPRIME #1\endfundefPRIME$$}
