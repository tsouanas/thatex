...
\def\funDefed#1{\DefFun #1 \fundefPRIME #1\endfundefPRIME}
\def\fundef#1\endfundef{$$\fundefPRIME #1\endfundefPRIME$$}% no \def takes place
\def\funDef#1:#2\\#3\endfunDef{$$\DefFun #1 \fundefPRIME \fun{#1}:#2\\#3\endfundefPRIME$$}% \def is local to this fundef
\def\funDEF#1:#2\\#3\endfunDEF{\DefFun #1 $$\fundefPRIME \fun{#1}:#2\\#3\endfundefPRIME$$}% \def takes place on the current scope
