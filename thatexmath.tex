...
\let\sugareq=\abbreq
\def\abbriff{\;\mathrel{\Lleftarrow\mkern-3mu\Rrightarrow}\;}
...
\def\unique{{\exists!}}
\def\quantifierabbr#1#2#3{\left(\/#1 #2\right)\!\left[\thinspace#3\thinspace\right]}
...
\def\toarrow#1{\mathrel{\decorateover{#1}{\mathord{-\mkern-8mu-\mkern-8mu\rightarrow}}}}
\def\fromarrow#1{\mathrel{\decorateover{#1}{\mathord{\leftarrow\mkern-8mu-\mkern-8mu-}}}}
...
\def\rcl#1{\mathrel{{#1}^{=}}}
\def\scl#1{\mathrel{{#1}^{\leftrightarrow}}}
\def\tcl#1{\mathrel{{#1}^{+}}}
\def\rtcl#1{\mathrel{{#1}^{+}}}
\def\ccl#1{\mathrel{{#1}^{\circ}}}
\def\recl#1{\mathrel{{#1}^{\triangleleft}}}
\def\lecl#1{\mathrel{{#1}^{\triangleright}}}
...
\def\dhole{{\ensuremath{\mathord{-}}}}
\def\bhole{{\ensuremath{\mathord{\bullet}}}}
