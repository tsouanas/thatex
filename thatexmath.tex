...
\def\plam#1#2{\paren{\lam{#1}{#2}}}% parenthesize whole term
\def\plamt#1#2{\paren{\lamt{#1}{#2}}}
...
\def\lamstep{\mathrel{\triangleright}}
\def\lamstep{\mathrel{\triangleright}}
\def\betastep{\mathrel{\triangleright_\beta}}
\def\etastep{\mathrel{\triangleright_\eta}}
\def\alphastep{\mathrel{\triangleright_\alpha}}
