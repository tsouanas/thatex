...
\newdimen\hremain   % to hold remaining hspace
\newdimen\hminsec   % constant of minimum hspace required to start a section
\hminsec=0ex        % XXX: this should be positive but 0ex seems big enough
...
\egroup%
\par%
\hremain=\dimexpr\hsize-\pagetotal\relax%
\ifdim\hremain<\hminsec\break%
\else\vskip 8ex\relax\goodbreak%
\fi
}
%%}}}
