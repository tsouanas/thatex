...
\def\structsmart{\ifvanishes\structaka\\\structclassname \structtag\else\structaka\spacechar(\structtag)\fi}%
...
\def\chapintro#1\par{\noi\introstylize{#1}\eop\chaptitleskip}
...
\def\paragahook{\noi\llap{\paragshowahang\paragshowasymbol}}
...
\noi
\bgroup
\ifpreproofhead\noi\argumentationheadstylize{\preproofhead}. \fi
\noi
\preproofbody
\egroup
\eop
...
\def\sourcecode#1; {\eop\bigskip{\sizex\def\setuplistinghook{\linenumberedlisting\nolastlinelisting}\listing{code/#1}}\bigskip\eop\noi}
%%}}}
