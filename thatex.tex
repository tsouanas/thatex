...
\def\TODO#1\par{{}\par\noindent {\color{todocolor}{$\blacktriangleright$}\sf\enspace#1}}
\def\TODOthis#1{{}\endgraf\noindent {\color{todocolor}{$\blacktriangleright$}\sf\enspace#1}\endgraf}
%%}}}
...
\let\sq=\symquote
\let\sqq=\symqquote
\let\msq=\mathsymquote
\let\msqq=\mathsymqquote
