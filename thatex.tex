...
% StrBehind had a bad name, but I keep StrBehind available too
\let\StrAfter=\StrBehind\relax
...
\def\ttable#1\endttable{\medskip\hfil\vbox{\halign{#1}}\hfil\medskip\noi}
