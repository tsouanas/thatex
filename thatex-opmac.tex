...
% vim:foldcolumn=4
%}}}
% parts from OPmac used in ThaTeX
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% ThaTeX: commented-out all this section
...
% ThaTeX: rename \label \ref \pgref to \opmac...
\def\opmaclabel[#1]{\isdefined{l0:#1}%
...
% ThaTeX: rename \cite \nocite to \opmac...
\def\opmaccite[#1]{{\citeA#1,,,[\printsavedcites]}}
\def\opmacnocite[#1]{{\citeA#1,,,}}
